...
export default {
  ...
  'sp.inspection': 'Doll is reviewing this page for you',

  'sp.greeting.html': 'Good to see you, darling. I\'m <strong>Doll</strong> — your personal secretary. I\'ll read your pages, take your dictation, handle the clicking and typing, fill out your forms, and run those tedious errands across the web.',
  'sp.greeting.hint': 'Try: "Summarize this page for me" or "Find every pricing link on here"',
  'sp.help_message': 'What can I take care of for you on this page?',
  'sp.cleared_message': 'Fresh slate, darling. What do you need?',

  'sp.mode.ask': 'Ask',
  'sp.mode.ask.title': 'Ask questions about the page — no changes made',
  'sp.mode.act': 'Act',
  'sp.mode.act.title': 'Let Doll click, type, and navigate on your behalf',
  'sp.mode.act.warning': 'Act mode: Doll will handle pages for you. Use at your own discretion.',
  'sp.mode.act.confirm': 'Act mode lets Doll click, type, scroll, and navigate on your behalf.\n\nShe runs inside your authenticated browser session — same access you have on every site you\'re logged into.\n\nKeep an eye on her and stop anytime with the ◼ button.\n\nShall I proceed, darling?',
  ...
  'sp.schedule_form.prompt_placeholder': 'What should Doll handle when this runs?',
  ...
  'sp.subscribe.allowance_used': 'Daily free Doll Cloud allowance used.',
  ...
  'sp.perm.question': 'Doll wants to {verb} {host}. Allow it?',
  'sp.perm.reason': 'Permission check — Doll only takes consequential actions on sites you allow.',
  ...
  'sp.slash.busy_only_oob': 'Only /help, /show-scratchpad, /list-schedules, /screenshot, /export, and /verbose can run while Doll is busy. Stop the run or try again when it finishes.',
  ...
  'ob.welcome.title': 'Meet Doll',
  'ob.welcome.body': 'Doll is your AI secretary — she lives right here in your sidebar. She reads pages, answers questions, fills forms, clicks buttons, and handles multi-step errands across the web. Discreet, efficient, and always at your service.',
  'ob.welcome.note': 'A quick briefing before we get to work, darling.',
  'ob.act.title': 'Before you let Doll act',
  'ob.act.body': 'In Act mode, Doll takes real actions on your behalf. Review her prompts, destinations, and outcomes before you let her proceed.',
  'ob.act.warn1': 'Doll may capture screenshots for planning. Avoid Act mode on sensitive pages — health, finance, dating, private accounts — unless you accept that risk.',
  ...
  'ob.tokens.body': 'Doll needs a language model to work. We\'ll check for local models first. If none are available, open Settings and add a provider:',
  'ob.tokens.scanning': 'Checking for local models...',
  'ob.tokens.local_body': 'A local model is available on this computer. Pick one to enable it and put Doll to work right away.',
  'ob.tokens.local_models_label': 'Local model',
  'ob.tokens.context_hint': 'For reliable runs, pick a model with at least a 16k-token context window. 8k can work with Compact mode enabled; 4k is too small for the tool set. Doll auto-compacts the conversation as it approaches the window.',
  ...
  'ob.tokens.option_lmstudio': 'LM Studio — run models locally for free. Start LM Studio, load a model, and Doll connects automatically.',
  ...
  'st.perms.gate.desc': 'Recommended. When on, Doll asks permission the first time she clicks, types, navigates, runs JavaScript, uploads, downloads, records, or schedules future work on a site (then remembers your choice). Turn off for fast, prompt-free use on sites you fully trust.',
  'st.perms.gate.warning': '⚠️ Permission prompts are OFF. Doll will click, type, navigate, run JavaScript, upload, download, record, and schedule future work on any site WITHOUT asking — including on pages whose content may be attacker-controlled. Page content is still treated as untrusted internally, but nothing will stop an injected instruction from triggering an action. Only leave this off if you fully trust every site you use your secretary on.',
  'st.perms.desc': 'Sites you have allowed Doll to act on. Each entry is one capability (click, type, navigate, run JavaScript, etc.) granted to a specific site. Remove any you no longer want — Doll will ask again next time she needs it.',
  'st.perms.empty': 'No site permissions granted yet. Doll asks before she clicks, types, navigates, uploads, downloads, records, schedules future work, or runs code on a site, and remembers your choice here when you pick “Always allow”.',
  ...
  'st.account.provider_name': 'Doll Cloud',
  ...
  'st.display.language.desc': 'Interface language for the Doll extension.',
  ...
  'st.display.api_mutation_observer.desc': 'Observe same-tab XHR/fetch request URLs and methods so Doll can detect repeated UI actions and suggest API shortcut patterns. Off by default; enable only while investigating shortcut behavior or latency.',
  ...
  'st.display.scheduled_tasks.desc': 'Allow Doll to resume deferred work and run one-shot or recurring scheduled tasks using browser alarms. On by default.',
  ...
  'st.profile.security_html': '<strong>Security — read this:</strong><br><ul style="margin:6px 0 0 18px;padding:0;line-height:1.55;"><li>The text you enter here is stored <strong>in plaintext</strong> in your browser\'s local storage. It is <strong>not</strong> transmitted to the Doll project — but it <strong>is</strong> sent to whichever LLM provider you have configured on every turn, as part of the system prompt.</li><li><strong>Do not put passwords for important accounts</strong> here (Google, Apple, iCloud, banking, work SSO, primary email). Those accounts should use 2FA and you shouldn\'t need to hand them to your secretary anyway.</li><li>A <strong>throwaway password</strong> you reuse for low-stakes site signups (newsletters, free trials, forum accounts) is the intended use case.</li><li>If this browser profile is ever compromised, an attacker with disk access can read this text. Keep it minimal.</li></ul>',
