...
export default {
  ...
  'ob.tokens.context_hint': "Pour des exécutions d'agent fiables, choisissez un modèle avec une fenêtre de contexte d'au moins 16k tokens. 8k peut convenir avec le mode Compact activé ; 4k est trop petit pour l'ensemble d'outils. Doll compacte automatiquement la conversation à l'approche de la limite de la fenêtre.",
  ...
  'ob.welcome.title': 'Bienvenue dans Doll',
  'ob.welcome.body': 'Doll est un agent de navigation IA dans votre barre latérale. Il peut lire des pages, répondre aux questions, remplir des formulaires, cliquer sur des boutons et automatiser des tâches web en plusieurs étapes.',
  'ob.welcome.note': 'Parcourons quelques points avant de commencer.',
  'ob.act.title': 'Vérifiez avant le mode Act',
  'ob.act.body': 'Le mode Act de Doll peut effectuer de vraies actions en votre nom. Vous devez vérifier les prompts, les destinations et les résultats avant de continuer.',
  'ob.act.warn1': 'Doll peut capturer des captures écran pour planifier. Évitez le mode agent sur les pages sensibles, comme santé, finance, rencontres ou portails de comptes privés, sauf si vous acceptez ce risque.',
  ...
  'ob.tokens.body': 'Doll a besoin d un modèle de langage pour fonctionner. Nous vérifierons d abord les modèles locaux. Si aucun modèle local est disponible, ouvrez les paramètres et ajoutez un fournisseur :',
  'ob.tokens.scanning': 'Recherche de modèles locaux...',
  'ob.tokens.local_body': 'Un modèle local est disponible sur cet ordinateur. Choisissez-en un pour l activer et commencer à utiliser Doll maintenant.',
  ...
  'ob.tokens.option_lmstudio': 'LM Studio : exécutez des modèles localement gratuitement. Lancez LM Studio, chargez un modèle, et Doll se connecte automatiquement.',
  ...
  'sp.inspection': 'Doll a commencé à inspecter cette page',

  'sp.greeting.html': 'Bonjour ! Je suis <strong>Doll</strong>. Je peux lire cette page, répondre à des questions, cliquer sur des boutons, remplir des formulaires et automatiser des tâches en plusieurs étapes.',
  ...
  'sp.mode.act': 'Agir',
  'sp.mode.act.title': 'Laissez Doll cliquer, taper et naviguer à votre place',
  'sp.mode.act.warning': 'Mode Agir : Doll interagira avec les pages à votre place. Utilisez-le à vos propres risques.',
  'sp.mode.act.confirm': 'Le mode Agir permet à Doll de cliquer, taper, défiler et naviguer à votre place.\n\nIl s\'exécute dans votre session de navigateur authentifiée et a donc le même accès que vous sur chaque site auquel vous êtes connecté.\n\nSurveillez ce qu\'il fait et arrêtez-le à tout moment avec le bouton ◼.\n\nContinuer ?',
  ...
  'sp.subscribe.allowance_used': 'Quota quotidien gratuit de Doll Cloud épuisé.',
  ...
  'st.display.language.desc': 'Langue de l\'interface de l\'extension Doll.',
  ...
  "sp.perm.question": "Doll souhaite {verb} {host}. L'autoriser ?",
  "sp.perm.reason": "Vérification d'autorisation — Doll n'effectue d'actions importantes que sur les sites que vous autorisez.",
  ...
  "st.perms.gate.desc": "Recommandé. Lorsque activé, Doll demande l'autorisation la première fois qu'il clique, saisit du texte, navigue, exécute du JavaScript, téléverse, télécharge ou enregistre sur un site (puis mémorise votre choix). Désactivez-le pour une utilisation rapide et sans invite sur les sites en lesquels vous avez pleinement confiance.",
  "st.perms.gate.warning": "⚠️ Les demandes d'autorisation sont DÉSACTIVÉES. Doll cliquera, saisira du texte, naviguera, exécutera du JavaScript, téléversera, téléchargera et enregistrera sur n'importe quel site SANS demander — y compris sur des pages dont le contenu peut être contrôlé par un attaquant. Le contenu des pages reste traité comme non fiable en interne, mais rien n'empêchera une instruction injectée de déclencher une action. Ne laissez ceci désactivé que si vous avez pleinement confiance en chaque site sur lequel vous utilisez l'assistant.",
  "st.perms.desc": "Sites sur lesquels vous avez autorisé Doll à agir. Chaque entrée correspond à une capacité (cliquer, saisir, naviguer, exécuter du JavaScript, etc.) accordée à un site précis. Supprimez celles dont vous ne voulez plus — Doll redemandera la prochaine fois qu'il en aura besoin.",
  "st.perms.empty": "Aucune autorisation de site accordée pour l'instant. Doll demande avant de cliquer, saisir, naviguer, téléverser, télécharger, enregistrer ou exécuter du code sur un site, et mémorise votre choix ici lorsque vous choisissez « Toujours autoriser ».",
  ...
  'sp.schedule_form.prompt_placeholder': 'Que doit faire Doll lors de cette exécution ?',
  ...
  'st.display.scheduled_tasks.desc': "Permet à Doll de reprendre les travaux différés et d'exécuter des tâches planifiées ponctuelles ou récurrentes via les alarmes du navigateur. Activé par défaut.",
