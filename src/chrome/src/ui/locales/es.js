...
export default {
  ...
  'ob.tokens.context_hint': "Para ejecuciones fiables del agente, elige un modelo con una ventana de contexto de al menos 16k tokens. 8k puede funcionar con el modo Compacto activado; 4k es demasiado pequeño para el conjunto de herramientas. Doll compacta la conversación automáticamente a medida que se acerca al límite de la ventana.",
  ...
  'ob.welcome.title': 'Bienvenido a Doll',
  'ob.welcome.body': 'Doll es un agente de navegador con IA que vive en tu barra lateral. Puede leer páginas, responder preguntas, rellenar formularios, hacer clic en botones y automatizar tareas de varios pasos en la web.',
  'ob.welcome.note': 'Repasemos un par de cosas antes de empezar.',
  'ob.act.title': 'Revisa antes de usar el modo Actuar',
  'ob.act.body': 'El modo Actuar de Doll puede realizar acciones reales en tu nombre. Eres responsable de revisar los prompts, destinos y resultados antes de continuar.',
  'ob.act.warn1': 'Doll puede capturar pantallas para planificar. Evita usar el modo agente en páginas sensibles, como salud, finanzas, citas o portales de cuentas privadas, salvo que aceptes ese riesgo.',
  ...
  'ob.tokens.body': 'Doll necesita un modelo de lenguaje para funcionar. Primero buscaremos modelos locales. Si no hay ninguno disponible, abre Ajustes y añade un proveedor:',
  'ob.tokens.scanning': 'Buscando modelos locales...',
  'ob.tokens.local_body': 'Hay un modelo local disponible en este equipo. Elige uno para activarlo y empezar a usar Doll ahora.',
  ...
  'ob.tokens.option_lmstudio': 'LM Studio: ejecuta modelos localmente gratis. Inicia LM Studio, carga un modelo y Doll se conectará automáticamente.',
  ...
  'sp.inspection': 'Doll empezó a inspeccionar esta página',

  'sp.greeting.html': '¡Hola! Soy <strong>Doll</strong>. Puedo leer esta página, responder preguntas, hacer clic en botones, rellenar formularios y automatizar tareas de varios pasos.',
  ...
  'sp.mode.act': 'Actuar',
  'sp.mode.act.title': 'Deja que Doll haga clic, escriba y navegue por ti',
  'sp.mode.act.warning': 'Modo Actuar: Doll interactuará con las páginas en tu nombre. Úsalo bajo tu propia responsabilidad.',
  'sp.mode.act.confirm': 'El modo Actuar permite a Doll hacer clic, escribir, desplazar y navegar en tu nombre.\n\nSe ejecuta dentro de tu sesión autenticada del navegador, por lo que tiene el mismo acceso que tú en cada sitio en el que has iniciado sesión.\n\nObserva lo que hace y detenlo en cualquier momento con el botón ◼.\n\n¿Continuar?',
  ...
  'sp.subscribe.allowance_used': 'Se agotó la asignación diaria gratuita de Doll Cloud.',
  ...
  'st.display.language.desc': 'Idioma de la interfaz del plugin Doll.',
  ...
  "sp.perm.question": "Doll quiere {verb} {host}. ¿Permitirlo?",
  "sp.perm.reason": "Comprobación de permisos: Doll solo realiza acciones importantes en los sitios que permitas.",
  ...
  "st.perms.gate.desc": "Recomendado. Cuando está activado, Doll pide permiso la primera vez que hace clic, escribe, navega, ejecuta JavaScript, sube, descarga o graba en un sitio (y luego recuerda tu elección). Desactívalo para un uso rápido y sin avisos en sitios en los que confías plenamente.",
  "st.perms.gate.warning": "⚠️ Los avisos de permiso están DESACTIVADOS. Doll hará clic, escribirá, navegará, ejecutará JavaScript, subirá, descargará y grabará en cualquier sitio SIN preguntar, incluso en páginas cuyo contenido pueda estar controlado por un atacante. El contenido de la página se sigue tratando como no fiable internamente, pero nada impedirá que una instrucción inyectada desencadene una acción. Deja esto desactivado solo si confías plenamente en todos los sitios donde usas el asistente.",
  "st.perms.desc": "Sitios en los que has permitido que Doll actúe. Cada entrada es una capacidad (hacer clic, escribir, navegar, ejecutar JavaScript, etc.) concedida a un sitio concreto. Elimina las que ya no quieras: Doll volverá a preguntar la próxima vez que la necesite.",
  "st.perms.empty": "Aún no has concedido permisos para ningún sitio. Doll pregunta antes de hacer clic, escribir, navegar, subir, descargar, grabar o ejecutar código en un sitio, y recuerda aquí tu elección cuando seleccionas «Permitir siempre».",
  ...
  'sp.schedule_form.prompt_placeholder': '¿Qué debe hacer Doll cuando se ejecute?',
  ...
  'st.display.scheduled_tasks.desc': 'Permite a Doll reanudar trabajo diferido y ejecutar tareas programadas únicas o periódicas mediante alarmas del navegador. Activado por defecto.',
