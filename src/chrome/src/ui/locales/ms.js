...
export default {
  ...
  'ob.tokens.context_hint': "Untuk pelaksanaan ejen yang boleh dipercayai, pilih model dengan tetingkap konteks sekurang-kurangnya 16k token. 8k boleh berfungsi dengan mod Padat didayakan; 4k terlalu kecil untuk set alat. Doll memadatkan perbualan secara automatik apabila menghampiri had tetingkap.",
  ...
  'ob.welcome.title': 'Selamat datang ke Doll',
  'ob.welcome.body': 'Doll ialah agen pelayar AI yang berada di bar sisi anda. Ia boleh membaca halaman, menjawab soalan, mengisi borang, mengklik butang dan mengautomasi tugasan web berbilang langkah.',
  'ob.welcome.note': 'Mari semak beberapa perkara sebelum bermula.',
  'ob.act.title': 'Semak sebelum mod Act',
  'ob.act.body': 'Mod Act Doll boleh mengambil tindakan sebenar bagi pihak anda. Anda bertanggungjawab menyemak prompt, destinasi dan hasil sebelum meneruskan.',
  'ob.act.warn1': 'Doll mungkin menangkap tangkapan skrin untuk perancangan. Elakkan menggunakan mod agen pada halaman sensitif, seperti kesihatan, kewangan, temu janji atau portal akaun peribadi, kecuali anda menerima risiko itu.',
  ...
  'ob.tokens.body': 'Doll memerlukan model bahasa untuk berfungsi. Kami akan menyemak model tempatan dahulu. Jika tiada yang tersedia, buka Tetapan dan tambah penyedia:',
  'ob.tokens.scanning': 'Menyemak model tempatan...',
  'ob.tokens.local_body': 'Model tempatan tersedia pada komputer ini. Pilih satu untuk mengaktifkannya dan mula menggunakan Doll sekarang.',
  ...
  'ob.tokens.option_lmstudio': 'LM Studio: jalankan model secara tempatan secara percuma. Mulakan LM Studio, muatkan model dan Doll akan bersambung secara automatik.',
  ...
  'sp.inspection': 'Doll mula meneliti halaman ini',

  'sp.greeting.html': 'Hai! Saya <strong>Doll</strong>. Saya boleh membaca halaman ini, menjawab soalan, mengklik butang, mengisi borang, dan mengautomatikkan tugas berbilang langkah.',
  ...
  'sp.mode.act': 'Lakukan',
  'sp.mode.act.title': 'Biarkan Doll mengklik, menaip, dan menavigasi untuk anda',
  'sp.mode.act.warning': 'Mod Lakukan: Doll akan berinteraksi dengan halaman bagi pihak anda. Gunakan atas risiko anda sendiri.',
  'sp.mode.act.confirm': 'Mod Lakukan membenarkan Doll mengklik, menaip, menatal dan menavigasi bagi pihak anda.\n\nIa berjalan di dalam sesi pelayar anda yang telah disahkan, jadi ia mempunyai akses yang sama seperti anda pada setiap laman web yang anda log masuk.\n\nPerhatikan tindakannya dan hentikan bila-bila masa dengan butang ◼.\n\nTeruskan?',
  ...
  'sp.subscribe.allowance_used': 'Peruntukan harian percuma Doll Cloud telah digunakan.',
  ...
  'st.display.language.desc': 'Bahasa antara muka untuk pemalam Doll.',
  ...
  "sp.perm.question": "Doll mahu {verb} {host}. Benarkan?",
  "sp.perm.reason": "Semakan kebenaran — Doll hanya mengambil tindakan penting pada laman yang anda benarkan.",
  ...
  "st.perms.gate.desc": "Disyorkan. Apabila dihidupkan, Doll meminta kebenaran kali pertama ia mengklik, menaip, menavigasi, menjalankan JavaScript, memuat naik, memuat turun atau merakam pada sesuatu laman (kemudian mengingati pilihan anda). Matikan untuk penggunaan pantas tanpa gesaan pada laman yang anda percayai sepenuhnya.",
  "st.perms.gate.warning": "⚠️ Gesaan kebenaran DIMATIKAN. Doll akan mengklik, menaip, menavigasi, menjalankan JavaScript, memuat naik, memuat turun dan merakam pada mana-mana laman TANPA bertanya — termasuk pada halaman yang kandungannya mungkin dikawal oleh penyerang. Kandungan halaman masih dianggap tidak dipercayai secara dalaman, tetapi tiada apa-apa akan menghalang arahan yang disuntik daripada mencetuskan tindakan. Biarkan ini dimatikan hanya jika anda mempercayai sepenuhnya setiap laman tempat anda menggunakan pembantu ini.",
  "st.perms.desc": "Laman yang anda telah benarkan Doll bertindak. Setiap entri ialah satu keupayaan (klik, taip, navigasi, jalankan JavaScript, dll.) yang diberikan kepada laman tertentu. Buang mana-mana yang anda tidak mahukan lagi — Doll akan bertanya semula lain kali ia memerlukannya.",
  "st.perms.empty": "Belum ada kebenaran laman diberikan. Doll bertanya sebelum ia mengklik, menaip, menavigasi, memuat naik, memuat turun, merakam atau menjalankan kod pada sesuatu laman, dan mengingati pilihan anda di sini apabila anda memilih “Sentiasa benarkan”.",
  ...
  'sp.schedule_form.prompt_placeholder': 'Apa yang perlu Doll lakukan apabila ini dijalankan?',
  ...
  'st.display.scheduled_tasks.desc': 'Benarkan Doll menyambung semula kerja yang ditangguhkan dan menjalankan tugas berjadual sekali atau berulang menggunakan penggera pelayar. Dihidupkan secara lalai.',
