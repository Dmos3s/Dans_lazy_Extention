...
export default {
  ...
  'ob.tokens.context_hint': "Untuk menjalankan agen secara andal, pilih model dengan jendela konteks minimal 16k token. 8k dapat berfungsi dengan mode Ringkas diaktifkan; 4k terlalu kecil untuk kumpulan alat. Doll memadatkan percakapan secara otomatis saat mendekati batas jendela.",
  ...
  'ob.welcome.title': 'Selamat datang di Doll',
  'ob.welcome.body': 'Doll adalah agen browser AI yang berada di bilah samping Anda. Doll dapat membaca halaman, menjawab pertanyaan, mengisi formulir, mengeklik tombol, dan mengotomatiskan tugas web multi-langkah.',
  'ob.welcome.note': 'Mari tinjau beberapa hal sebelum mulai.',
  'ob.act.title': 'Tinjau sebelum mode Act',
  'ob.act.body': 'Mode Act Doll dapat melakukan tindakan nyata atas nama Anda. Anda bertanggung jawab meninjau prompt, tujuan, dan hasil sebelum melanjutkan.',
  'ob.act.warn1': 'Doll dapat menangkap screenshot untuk perencanaan. Hindari memakai mode agen pada halaman sensitif, seperti kesehatan, keuangan, kencan, atau portal akun pribadi, kecuali Anda menerima risikonya.',
  ...
  'ob.tokens.body': 'Doll membutuhkan model bahasa untuk bekerja. Kami akan memeriksa model lokal terlebih dahulu. Jika tidak ada yang tersedia, buka Pengaturan dan tambahkan penyedia:',
  'ob.tokens.scanning': 'Memeriksa model lokal...',
  'ob.tokens.local_body': 'Model lokal tersedia di komputer ini. Pilih satu untuk mengaktifkannya dan mulai memakai Doll sekarang.',
  ...
  'ob.tokens.option_lmstudio': 'LM Studio: jalankan model secara lokal gratis. Mulai LM Studio, muat model, dan Doll akan terhubung otomatis.',
  ...
  'sp.inspection': 'Doll mulai memeriksa halaman ini',

  'sp.greeting.html': 'Halo! Saya <strong>Doll</strong>. Saya bisa membaca halaman ini, menjawab pertanyaan, mengeklik tombol, mengisi formulir, dan mengotomatiskan tugas multi-langkah.',
  ...
  'sp.mode.act': 'Aksi',
  'sp.mode.act.title': 'Biarkan Doll mengeklik, mengetik, dan menavigasi untukmu',
  'sp.mode.act.warning': 'Mode aksi: Doll akan berinteraksi dengan halaman atas nama Anda. Gunakan dengan risiko Anda sendiri.',
  'sp.mode.act.confirm': 'Mode aksi memungkinkan Doll mengeklik, mengetik, menggulir, dan menavigasi atas nama Anda.\n\nIa berjalan di dalam sesi peramban Anda yang sudah terautentikasi, jadi memiliki akses yang sama seperti Anda di setiap situs tempat Anda masuk.\n\nPerhatikan tindakannya dan hentikan kapan saja dengan tombol ◼.\n\nLanjutkan?',
  ...
  'sp.subscribe.allowance_used': 'Kuota harian gratis Doll Cloud telah habis.',
  ...
  'st.display.language.desc': 'Bahasa antarmuka untuk plugin Doll.',
  ...
  "sp.perm.question": "Doll ingin {verb} {host}. Izinkan?",
  "sp.perm.reason": "Pemeriksaan izin — Doll hanya melakukan tindakan penting pada situs yang Anda izinkan.",
  ...
  "st.perms.gate.desc": "Disarankan. Saat aktif, Doll meminta izin pertama kali ia mengeklik, mengetik, menavigasi, menjalankan JavaScript, mengunggah, mengunduh, atau merekam pada sebuah situs (lalu mengingat pilihan Anda). Matikan untuk penggunaan cepat tanpa konfirmasi pada situs yang sepenuhnya Anda percayai.",
  "st.perms.gate.warning": "⚠️ Konfirmasi izin NONAKTIF. Doll akan mengeklik, mengetik, menavigasi, menjalankan JavaScript, mengunggah, mengunduh, dan merekam pada situs apa pun TANPA bertanya — termasuk pada halaman yang kontennya mungkin dikendalikan penyerang. Konten halaman tetap diperlakukan sebagai tidak tepercaya secara internal, tetapi tidak ada yang akan mencegah instruksi yang disisipkan memicu sebuah tindakan. Biarkan nonaktif hanya jika Anda sepenuhnya memercayai setiap situs tempat Anda memakai asisten ini.",
  "st.perms.desc": "Situs yang telah Anda izinkan untuk ditindaklanjuti Doll. Setiap entri adalah satu kapabilitas (mengeklik, mengetik, menavigasi, menjalankan JavaScript, dll.) yang diberikan ke situs tertentu. Hapus yang tak lagi Anda inginkan — Doll akan bertanya lagi saat berikutnya membutuhkannya.",
  "st.perms.empty": "Belum ada izin situs yang diberikan. Doll bertanya sebelum mengeklik, mengetik, menavigasi, mengunggah, mengunduh, merekam, atau menjalankan kode pada sebuah situs, dan mengingat pilihan Anda di sini saat Anda memilih “Selalu izinkan”.",
  ...
  'sp.schedule_form.prompt_placeholder': 'Apa yang harus dilakukan Doll saat ini dijalankan?',
  ...
  'st.display.scheduled_tasks.desc': 'Izinkan Doll melanjutkan pekerjaan yang ditangguhkan dan menjalankan tugas terjadwal sekali atau berulang menggunakan alarm peramban. Aktif secara bawaan.',
