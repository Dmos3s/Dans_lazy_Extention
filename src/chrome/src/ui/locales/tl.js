...
export default {
  ...
  'ob.tokens.context_hint': "Para sa maaasahang pagpapatakbo ng agent, pumili ng modelo na may context window na hindi bababa sa 16k token. Maaaring gumana ang 8k kapag naka-enable ang Compact mode; masyadong maliit ang 4k para sa set ng mga tool. Awtomatikong kino-compact ng Doll ang usapan habang papalapit ito sa limitasyon ng window.",
  ...
  'ob.welcome.title': 'Maligayang pagdating sa Doll',
  'ob.welcome.body': 'Ang Doll ay isang AI browser agent sa iyong sidebar. Kaya nitong basahin ang mga pahina, sumagot ng tanong, mag-fill out ng forms, mag-click ng buttons, at mag-automate ng multi-step na gawain sa web.',
  'ob.welcome.note': 'Tingnan muna natin ang ilang bagay bago ka magsimula.',
  'ob.act.title': 'Suriin bago ang Act mode',
  'ob.act.body': 'Ang Doll Act mode ay maaaring gumawa ng tunay na aksyon sa ngalan mo. Responsibilidad mong suriin ang prompts, destinasyon, at resulta bago magpatuloy.',
  'ob.act.warn1': 'Maaaring kumuha ang Doll ng screenshots para sa pagpaplano. Iwasang gamitin ang agent mode sa sensitibong pahina, tulad ng health, finance, dating, o pribadong account portals, maliban kung tinatanggap mo ang panganib.',
  ...
  'ob.tokens.body': 'Kailangan ng Doll ng language model para gumana. Susuriin muna namin ang mga lokal na modelo. Kung walang available, buksan ang Settings at magdagdag ng provider:',
  'ob.tokens.scanning': 'Sinusuri ang mga lokal na modelo...',
  'ob.tokens.local_body': 'May lokal na modelong available sa computer na ito. Pumili ng isa para i-enable ito at simulang gamitin ang Doll ngayon.',
  ...
  'ob.tokens.option_lmstudio': 'LM Studio: magpatakbo ng models nang lokal nang libre. Simulan ang LM Studio, mag-load ng modelo, at awtomatikong kokonekta ang Doll.',
  ...
  'sp.inspection': 'Sinimulan ng Doll na suriin ang pahinang ito',

  'sp.greeting.html': 'Kumusta! Ako si <strong>Doll</strong>. Kaya kong basahin ang pahinang ito, sumagot ng mga tanong, mag-click ng mga button, magpuno ng mga form, at mag-automate ng mga multi-step na gawain.',
  ...
  'sp.mode.act': 'Aksyon',
  'sp.mode.act.title': 'Hayaan ang Doll na mag-click, mag-type, at mag-navigate para sa iyo',
  'sp.mode.act.warning': 'Aksyon mode: Makikipag-interaksyon ang Doll sa mga pahina sa ngalan mo. Gamitin nang may pag-iingat.',
  'sp.mode.act.confirm': 'Hinahayaan ng Aksyon mode ang Doll na mag-click, mag-type, mag-scroll, at mag-navigate para sa iyo.\n\nTumatakbo ito sa loob ng iyong naka-authenticate na browser session, kaya may parehong access ito na tulad mo sa bawat site kung saan ka naka-log in.\n\nBantayan ang ginagawa nito at itigil ito anumang oras gamit ang ◼ button.\n\nMagpatuloy?',
  ...
  'sp.subscribe.allowance_used': 'Naubos na ang libreng pang-araw-araw na alokasyon ng Doll Cloud.',
  ...
  'st.display.language.desc': 'Wika ng interface para sa Doll plugin.',
  ...
  "sp.perm.question": "Gusto ng Doll na {verb} {host}. Papayagan ba?",
  "sp.perm.reason": "Pagsusuri ng pahintulot — mahahalagang aksyon lang ang ginagawa ng Doll sa mga site na pinapayagan mo.",
  ...
  "st.perms.gate.desc": "Inirerekomenda. Kapag naka-on, humihingi ng pahintulot ang Doll sa unang pagkakataong mag-click, mag-type, mag-navigate, magpatakbo ng JavaScript, mag-upload, mag-download, o mag-record ito sa isang site (at saka tinatandaan ang iyong pinili). I-off para sa mabilis at walang prompt na paggamit sa mga site na lubos mong pinagkakatiwalaan.",
  "st.perms.gate.warning": "⚠️ Naka-OFF ang mga prompt ng pahintulot. Mag-cli-click, magta-type, magna-navigate, magpapatakbo ng JavaScript, mag-aupload, mag-dadownload, at magre-record ang Doll sa anumang site nang HINDI nagtatanong — kasama na ang mga pahinang ang nilalaman ay maaaring kontrolado ng attacker. Itinuturing pa ring untrusted ang nilalaman ng pahina sa loob, ngunit walang pipigil sa isang injected na tagubilin na mag-trigger ng aksyon. Iwang naka-off lamang ito kung lubos mong pinagkakatiwalaan ang bawat site na ginagamitan mo ng assistant.",
  "st.perms.desc": "Mga site na pinayagan mong kilusin ng Doll. Bawat entry ay isang kakayahan (click, type, navigate, magpatakbo ng JavaScript, atbp.) na ibinigay sa isang partikular na site. Alisin ang anumang hindi mo na gusto — magtatanong muli ang Doll sa susunod na kailanganin niya ito.",
  "st.perms.empty": "Wala pang ibinigay na pahintulot sa site. Nagtatanong ang Doll bago ito mag-click, mag-type, mag-navigate, mag-upload, mag-download, mag-record, o magpatakbo ng code sa isang site, at tinatandaan dito ang iyong pinili kapag pinili mong “Palaging payagan”.",
  ...
  "st.display.strict_secret.desc": "Tanggihang i-quote ang mga kredensyal (password, API key, token, OTPs) sa mga summary o teksto ng assistant — kahit hayagan mong hilingin ang mga ito. Mainam kung madalas kang magbahagi ng trace files o screen-share. Naka-off bilang default: tumatakbo ang Doll sa sarili mong browser, kaya bilang default ay ipinapakita sa iyo ng ahente ang mga value na hiniling mo at pinapanatili lang na malinis ang mga `done` na summary.",
  ...
  'sp.schedule_form.prompt_placeholder': 'Ano ang gagawin ng Doll kapag ito ay naisakatuparan?',
  ...
  'st.display.scheduled_tasks.desc': 'Payagan ang Doll na ipagpatuloy ang ipinagpalibang trabaho at magpatakbo ng isang beses o paulit-ulit na mga naka-iskedyul na gawain gamit ang mga browser alarm. Naka-on bilang default.',
