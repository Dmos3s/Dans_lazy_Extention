...
export default {
  ...
  'ob.tokens.context_hint': "Güvenilir aracı çalıştırmaları için en az 16k token bağlam penceresine sahip bir model seçin. 8k, Kompakt mod etkinken çalışabilir; 4k, araç seti için fazla küçüktür. Doll, pencere sınırına yaklaştıkça konuşmayı otomatik olarak sıkıştırır.",
  ...
  'ob.welcome.title': 'Doll hoş geldiniz',
  'ob.welcome.body': 'Doll, yan panelinizde yaşayan bir yapay zeka tarayıcı aracıdır. Sayfaları okuyabilir, soruları yanıtlayabilir, formları doldurabilir, düğmelere tıklayabilir ve webde çok adımlı görevleri otomatikleştirebilir.',
  'ob.welcome.note': 'Başlamadan önce birkaç şeyi hızlıca gözden geçirelim.',
  'ob.act.title': 'Uygula modundan önce inceleyin',
  'ob.act.body': 'Doll Uygula modu sizin adınıza gerçek işlemler yapabilir. Devam etmeden önce istemleri, hedefleri ve sonuçları incelemek sizin sorumluluğunuzdadır.',
  'ob.act.warn1': 'Doll planlama için ekran görüntüleri yakalayabilir. Bu riski kabul etmedikçe sağlık, finans, flört veya özel hesap portalları gibi hassas sayfalarda aracı modunu kullanmaktan kaçının.',
  ...
  'ob.tokens.body': 'Doll çalışmak için bir dil modeline ihtiyaç duyar. Önce yerel modelleri kontrol edeceğiz. Hiçbiri yoksa Ayarlar bölümünü açıp bir sağlayıcı ekleyin:',
  'ob.tokens.scanning': 'Yerel modeller kontrol ediliyor...',
  'ob.tokens.local_body': 'Bu bilgisayarda bir yerel model var. Etkinleştirmek ve Doll kullanmaya başlamak için birini seçin.',
  ...
  'ob.tokens.option_lmstudio': 'LM Studio: modelleri ücretsiz olarak yerelde çalıştırın. LM Studio başlatın, bir model yükleyin ve Doll otomatik bağlansın.',
  ...
  'sp.inspection': 'Doll bu sayfayı incelemeye başladı',

  'sp.greeting.html': 'Merhaba! Ben <strong>Doll</strong>. Bu sayfayı okuyabilir, sorularını yanıtlayabilir, düğmelere tıklayabilir, formları doldurabilir ve çok adımlı görevleri otomatikleştirebilirim.',
  ...
  'sp.mode.act': 'Uygula',
  'sp.mode.act.title': 'Doll senin yerine tıklasın, yazsın ve gezinsin',
  'sp.mode.act.warning': 'Uygula modu: Doll sayfalarla senin adına etkileşime girer. Kendi sorumluluğunda kullan.',
  'sp.mode.act.confirm': 'Uygula modu, Doll\'in senin adına tıklamasına, yazmasına, kaydırmasına ve gezinmesine izin verir.\n\nKimliği doğrulanmış tarayıcı oturumunun içinde çalışır, yani giriş yaptığın her sitede senin sahip olduğun erişim yetkisine sahiptir.\n\nNe yaptığını izle ve istediğin an ◼ düğmesiyle durdur.\n\nDevam edilsin mi?',
  ...
  'sp.subscribe.allowance_used': 'Ücretsiz günlük Doll Cloud kullanım hakkınız doldu.',
  ...
  'st.display.language.desc': 'Doll eklentisinin arayüz dili.',
  ...
  'st.profile.security_html': '<strong>Güvenlik — lütfen oku:</strong><br><ul style="margin:6px 0 0 18px;padding:0;line-height:1.55;"><li>Buraya yazdığın metin tarayıcının yerel depolamasında <strong>düz metin olarak</strong> saklanır. <strong>Doll projesine iletilmez</strong> — fakat yapılandırdığın LLM sağlayıcısına her turda sistem isteminin bir parçası olarak <strong>gönderilir</strong>.</li><li><strong>Önemli hesapların parolalarını buraya koyma</strong> (Google, Apple, iCloud, bankacılık, iş SSO\'su, birincil e-posta). Bu hesaplar 2FA kullanmalı ve zaten bir aracıya teslim edilmemeli.</li><li>Düşük riskli site kayıtları (bültenler, ücretsiz denemeler, forum hesapları) için kullandığın <strong>tek kullanımlık bir parola</strong> hedeflenen kullanım durumudur.</li><li>Bu tarayıcı profili ele geçirilirse, diske erişebilen bir saldırgan bu metni okuyabilir. Asgaride tut.</li></ul>',

  'tr.title': 'Doll İzleri',
  'tr.runs': '{n} çalışma',
  'tr.run': '{n} çalışma',
  ...
  "sp.perm.question": "Doll {host} adresinde {verb} istiyor. İzin veriyor musun?",
  "sp.perm.reason": "İzin kontrolü — Doll yalnızca senin izin verdiğin sitelerde önemli işlemler yapar.",
  ...
  "st.perms.gate.desc": "Önerilir. Açıkken Doll, bir sitede ilk kez tıkladığında, yazdığında, gezindiğinde, JavaScript çalıştırdığında, dosya yüklediğinde, indirdiğinde veya kayıt yaptığında izin ister (sonra seçimini hatırlar). Tamamen güvendiğin sitelerde hızlı, istemsiz kullanım için kapat.",
  "st.perms.gate.warning": "⚠️ İzin istemleri KAPALI. Doll herhangi bir sitede SORMADAN tıklayacak, yazacak, gezinecek, JavaScript çalıştıracak, dosya yükleyecek, indirecek ve kayıt yapacak — içeriği saldırgan kontrolünde olabilecek sayfalar dahil. Sayfa içeriği yine de dahili olarak güvenilmez kabul edilir, ama enjekte edilmiş bir talimatın bir işlemi tetiklemesini hiçbir şey engellemez. Bunu yalnızca asistanı kullandığın her siteye tamamen güveniyorsan kapalı bırak.",
  "st.perms.desc": "Doll'in işlem yapmasına izin verdiğin siteler. Her giriş, belirli bir siteye verilmiş tek bir yetkidir (tıklama, yazma, gezinme, JavaScript çalıştırma vb.). Artık istemediklerini kaldır — Doll bir sonraki ihtiyaç duyduğunda yeniden soracak.",
  "st.perms.empty": "Henüz hiçbir site izni verilmedi. Doll bir sitede tıklamadan, yazmadan, gezinmeden, dosya yüklemeden, indirmeden, kayıt yapmadan veya kod çalıştırmadan önce sorar ve “Her zaman izin ver” seçtiğinde seçimini burada hatırlar.",
  ...
  "st.display.strict_secret.desc": "Özellikle istesen bile, özetlerde veya asistan metninde kimlik bilgilerini (parolalar, API anahtarları, jetonlar, OTP'ler) aktarmayı reddet. Düzenli olarak iz dosyaları paylaşıyorsan veya ekran paylaşımı yapıyorsan kullanışlıdır. Varsayılan olarak kapalı: Doll kendi tarayıcında çalışır, bu yüzden varsayılan olarak aracı istediğin değerleri sana gösterir ve yalnızca `done` özetlerini derli toplu tutar.",
  ...
  'sp.schedule_form.prompt_placeholder': 'Bu çalıştığında Doll ne yapmalı?',
  ...
  'st.display.scheduled_tasks.desc': "Doll'in ertelenmiş çalışmaları devam ettirmesine ve tarayıcı alarmlarını kullanarak tek seferlik veya yinelenen zamanlanmış görevler çalıştırmasına izin verir. Varsayılan olarak etkin.",
